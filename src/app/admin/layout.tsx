...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (isNoLayoutPage) {
    return (
      <div className="flex items-center justify-center h-screen bg-[linear-gradient(to_top_right,#2E0038,#3E0053,#5A0076,#6D0089,#7F00A0,#9B00B2,#B700C4,#D200D6,#E600E6)]">
        {children}
      </div>
    );
  }
  ...
  return (
    <div className="h-screen w-screen flex bg-[linear-gradient(to_top_right,#2E0038,#3E0053,#5A0076,#6D0089,#7F00A0,#9B00B2,#B700C4,#D200D6,#E600E6)]">
      {/* Sidebar */}
      <nav 
        ref={navRef}
